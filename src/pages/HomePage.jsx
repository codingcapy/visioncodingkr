export default function HomePage() {
	return (
		<main className="flex-1">
			<div className="">
				<section className="home-banner h-[800px] md:h-[680px] py-10 pt-20 bg-gradient-to-t from-indigo-900 to-gray-900 text-white">
					<h1 className="text-4xl md:text-5xl text-center text-white py-5 font-bold">
						북미 IT 시장에서
					</h1>
					...
					<div className="md:grid grid-cols-5 mt-32 py-10 bg-blue-950">
						...
						<div className="text-center border-r-2 border-gray-400">
							...
							<p>매주 토요일, 오전 9시 ~ 11시30분 (메인 강의)</p>
							<p>매주 일요일, 오전 10시 ~ 오후 12시 (스터디 그룹)</p>
						</div>
