        ...
        <main className="flex-1">
            <div className="">
                <section className="home-banner h-[400px] md:h-[600px] py-10 bg-gradient-to-t from-blue-900 to-black text-white">
                    <h1 className="text-6xl text-center text-white">한국 개발자들이</h1>
                    <h1 className="text-6xl text-center text-white py-5">북미 IT 시장에서</h1>
                    <h1 className="text-6xl text-center text-white"><span className="text-teal-500">성공적</span>으로 <span className="text-teal-500">취업하기</span></h1>
                    <button className="my-10 px-10 py-5 bg-red-500 rounded-xl text-white flex flex-col mx-auto">참가 신청 하기</button>
